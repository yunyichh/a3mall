...
//        $email = Email::send('2899596110@qq.com','恭喜你','哈哈哈哈');

        $email =1;
        if ($email){
            return $this->returnAjax(  lang('Email sent successfully'),1,[]);
        }else{
            return $this->returnAjax(lang('Failed to send mail'),-1,[]);
        }
    }
}
