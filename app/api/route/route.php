...
Route::group(function(){
    //发送邮箱
    Route::any('sendEmail', 'api/wap.index/send_email');
...
})->middleware(AllowOrigin::class)->middleware(LoadLangPack::class);
...
})->middleware(AllowOrigin::class)->middleware(VerifyToken::class)->middleware(LoadLangPack::class);
